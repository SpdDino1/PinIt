...
public class SensorManager implements SensorEventListener{
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        sensorAngleResult.passResult(
                (int)Math.round(orientationAngles[0]*(180/3.141)),
                (int)Math.round(orientationAngles[2]*(180/3.141)),
                (int)Math.round(orientationAngles[1]*(180/3.141))
        );
    }
